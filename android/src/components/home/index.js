  ...
  render() {
    return (
      <View style={styles.container} >
        ...
        <TimersList navigation={this.props.navigation} updateTicketCount={this.updateTicketCount.bind(this)}/>
      </View>
    );
  }

  componentWillMount() {
    this.ticketCount = this.realm.objects('Ticketed')[0] ? this.realm.objects('Ticketed')[0].list.length : 0;
  }
