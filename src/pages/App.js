...
import Schema from '../utils/realm';
import { initialize as FirebaseInitialize, signInUser as FirebaseSignIn }  from '../api/firebase';
          ...
          <TouchableNativeFeedback 
            ...
            <View style={styles.resetContainer}>
              <View style={styles.icon}>
                <Image source={require('../images/reset-icon.png')}/>
              </View>
